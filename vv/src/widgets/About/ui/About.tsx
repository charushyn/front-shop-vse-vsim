...
export default function About(){
    return(
        <div className="px-4 my-8 flex flex-col gap-4 t-s:px-8" id="about">
            {/* text block */}
...
Ми забезпечуємо високий рівень обслуговування, оперативну доставку та індивідуальний підхід до кожного клієнта, що робить нас надійним партнером як для малого бізнесу, так і для великих компаній."></P>
            ...
            <img src="https://st2.depositphotos.com/3243153/7247/i/450/depositphotos_72476397-stock-photo-children-playing-with-wooden-toys.jpg"></img>
        </div>
    )
}
